...
get_update_key_and_dictionary(std::ifstream *input_stream, bool is_cin) {
    ...
    while (iterations) {
        ...
        if (field_name == "meeting_type") {
            dbValueField = db_value_fields::_meeting_type_;
        } else if (field_name == "meeting_format") {
            dbValueField = db_value_fields::_meeting_format_;
        } else if (field_name == "meeting_description") {
            dbValueField = db_value_fields::_meeting_description_;
        } else if (field_name == "link_to_meeting") {
            dbValueField = db_value_fields::_link_to_meeting_;
        ...
        } else if (field_name == "meeting_date") {
            dbValueField = db_value_fields::_meeting_date_;
        } else if (field_name == "meeting_time") {
            dbValueField = db_value_fields::_meeting_time_;
        } else if (field_name == "duration") {
            dbValueField = db_value_fields::_duration_;
        } else if (field_name == "list_of_invitees") {
            dbValueField = db_value_fields::_list_of_invitees_;
        } else {
        ...
        if (dbValueField == db_value_fields::_meeting_type_ || dbValueField == db_value_fields::_meeting_format_ ||
            dbValueField == db_value_fields::_meeting_description_ || dbValueField == db_value_fields::_link_to_meeting_ ||
            dbValueField == db_value_fields::_surname_ || dbValueField == db_value_fields::_name_ ||
            dbValueField == db_value_fields::_patronymic_ ||
            dbValueField == db_value_fields::_meeting_date_ || dbValueField == db_value_fields::_meeting_time_ ||
            dbValueField == db_value_fields::_list_of_invitees_) {
            to_return_dict[dbValueField] = reinterpret_cast<unsigned char *>(new std::string(token));
        } else if (dbValueField == db_value_fields::_duration_) {
            // try catch?
            try {
