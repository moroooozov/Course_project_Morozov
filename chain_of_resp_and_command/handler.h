...
public:
    explicit add_handler(db_value * new_value)
    {
        ...
        command_input[db_value_fields::_meeting_type_] =
                reinterpret_cast<unsigned char *>(new std::string(*(new_value->_meeting_type)));
        command_input[db_value_fields::_meeting_format_] =
                reinterpret_cast<unsigned char *>(new std::string(*(new_value->_meeting_format)));
        command_input[db_value_fields::_meeting_description_] =
                reinterpret_cast<unsigned char *>(new std::string(*(new_value->_meeting_description)));
        command_input[db_value_fields::_link_to_meeting_] =
                reinterpret_cast<unsigned char *>(new std::string(*(new_value->_link_to_meeting)));
        ...
        command_input[db_value_fields::_meeting_date_] =
                reinterpret_cast<unsigned char *>(new std::string(*(new_value->_meeting_date)));
        command_input[db_value_fields::_meeting_time_] =
                reinterpret_cast<unsigned char *>(new std::string(*(new_value->_meeting_time)));
        command_input[db_value_fields::_duration_] =
                reinterpret_cast<unsigned char *>(new int(new_value->_duration));
        command_input[db_value_fields::_list_of_invitees_] =
                reinterpret_cast<unsigned char *>(new std::string(*(new_value->_list_of_invitees)));
